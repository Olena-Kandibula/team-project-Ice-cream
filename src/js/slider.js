      ...
      var slideShow = (function () {
        return function (selector, config) {
          var _slider = document.querySelector(selector), 
            _sliderContainer = _slider.querySelector(".clients__slider-list"), 
            _sliderItems = _slider.querySelectorAll(".clients__slider-item"), 
          ...
          var _setUpListeners = function () {
            ...
            if (_isTouchDevice()) {
              ...
              for (
                var i = 0, length = _sliderControls.length;
                i < length;
                i++
              ) {
          ...
          var _addIndicators = function () {
            ...
            indicatorsContainer.classList.add("clients__slider-indicators");
            for (var i = 0, length = _sliderItems.length; i < length; i++) {
            ...
            _indicatorItems = _slider.querySelectorAll(
              ".clients__slider-indicators> li"
            );
          };
